...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        examples = (
            processor.get_eval_examples(args.eval_file_path)
            if evaluate
            else processor.get_train_examples(args.train_file_path)
        )
...
def main():
    ...
    # Required parameters
    parser.add_argument(
        "--train_file_path", default=None, type=str, required=True
    )
    parser.add_argument(
        "--eval_file_path", default=None, type=str, required=True
    )
    parser.add_argument(
        "--model_dir",
        default=None,
    ...
    config = BertConfig.from_pretrained(
        args.model_dir, num_labels=num_labels, finetuning_task=args.task_name
    )
